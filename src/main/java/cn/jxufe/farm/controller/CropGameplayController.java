...
public class CropGameplayController {
  ...
  @Operation(
      summary = "种植作物",
      description = "在指定地块种植种子。校验土壤兼容性、种子库存，扣减种子并创建作物实例，设置成熟/枯萎时间轴。需传幂等 requestId")
  ...
  @Operation(
      summary = "收获作物",
      description = "收获成熟作物。计算虫害减产，增加果实库存、经验、积分。多次收获作物回退到 regrow 阶段。需传幂等 requestId")
  ...
  public R<PageResult<CropActionLogRecordVO>> pageCropActionLogs(
      @Valid @RequestBody CropActionLogQueryDTO params) {
